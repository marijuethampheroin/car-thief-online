...
_Last updated: 2026-05-14 (session 29)_
...
| File | Role |
|---|---|
| `index.html` | Landing page — title, description, live MP stats, Sign In/Out, Play Multiplayer / Play Solo buttons |
...
| `game.js` | Client-side state + all game logic (shared by SP and MP screens) |
...
| File | Role |
|---|---|
| `play.html` | MP room browser — Browse/Create tabs, live room list, auto-join via `?join=CODE`; login-gated |
| `game.html` | MP main screen — HUD, city map, panels, contacts, vehicles, items |
...
| `styles_v2.css` | MP-specific stylesheet (used by game.html and related screens) |
| `server.js` | Node.js + WebSocket backend; room management, day timer, room list push |
| `logic.js` | Server-side mirror of game logic (no DOM); kept in sync with game.js |
| `package.json` | Node dependencies (ws, firebase-admin) |

### Singleplayer / Classic
| File | Role |
|---|---|
| `classic.html` | SP entry + main screen — name, portrait, profession, city picker; full singleplayer session |
...
| Path | Used by |
|---|---|
| `Graphics/UI_elements/background.bmp` | classic.html (panel bg) |
| `Graphics/UI_elements/background_crime.bmp` | crime.html (window bg) |
| `Graphics/UI_elements/city01–07.bmp` | game.html, classic.html (`applyCityMap`) |
...
| `Graphics/UI_elements/map_usa.bmp` | index.html, play.html, airport.html (city picker) |
...
| Path | Used by |
|---|---|
| `Graphics/portraits/portrait_1–18.png` | index.html, play.html (player portrait picker); portraits 7–18 sliced from sheets by `slice_portraits.py` |
| `Graphics/character_portraits_full/person01–28.png` | game.js (`generateContact`), contacts modal |

### Vehicles
| Path | Used by |
|---|---|
| `Graphics/pixel_cars/cars01–13.png` | game.js / logic.js / server.js (`_enrichVehicle`); game.html, classic.html (garage/team/storage slots); race.html |

### Items
| Path | Used by |
|---|---|
| `Graphics/items_medium/STOOL01–44.bmp` | game.html, classic.html (backpack/store grid); arrested.html (confiscation list) |
| `Graphics/items_full/TOOL01–44.png` | game.html, classic.html (store panel selected item detail) |

### Drugs
| Path | Used by |
|---|---|
| `Graphics/drugs/weed_small.png`, `weed_large.png` | game.html, classic.html (dealer panel inventory) |
| `Graphics/drugs/cocaine_small.png`, `cocaine_large.png` | game.html, classic.html (dealer panel inventory) |
| `Graphics/drugs/ecstasy_small.png`, `ecstasy_large.png` | game.html, classic.html (dealer panel inventory) |
| `Graphics/drugs/shrooms_small.png`, `shrooms_large.png` | game.html, classic.html (dealer panel inventory) |
| `Graphics/drugs/heroin_small.png` | game.html, classic.html (dealer panel inventory) |

### NPC Portraits
| Path | Used by |
|---|---|
| `Graphics/dealers/dealer01–07.png` | game.html, classic.html (dealer NPC portraits) |
